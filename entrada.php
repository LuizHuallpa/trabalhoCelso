...
<html lang="pt-br">
  ...
  <body>
    <div class="container-fluid bgEntrada"></div>
      <h1 class="text-center">Conselho Tutelar</h1>
      <h5 class="text-center">Informe os dados para contagem</h5>
      <h5 class="text-center">Todos os campos são de preenchimento obrigatorio</h5>
      <form name="form" id="form" action="contagem.php" method="POST">
        ...
        <div class="text-center">
          <button class="btn-primary p-2 mt-4" type="submit">Enviar</button>
        </div>
      </form>
